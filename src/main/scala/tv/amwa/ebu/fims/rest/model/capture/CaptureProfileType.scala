...
trait CaptureProfileType extends ProfileType {
  val serviceParameters: CaptureProfileParameters
...
case class CaptureProfile(
    resourceParameters: ResourceParameters,
    baseParameters: BaseProfileParameters,
    serviceParameters: CaptureProfileParameters) extends CaptureProfileType
    
case class CaptureProfileParameters(
