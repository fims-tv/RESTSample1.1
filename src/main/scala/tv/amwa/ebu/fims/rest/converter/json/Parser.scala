...
package tv.amwa.ebu.fims.rest.converter.json
 ...
 */
case class JSONObject (obj : ListMap[String,Any]) extends JSONType {
...
class Parser extends StdTokenParsers with ImplicitConversions {
  ...
  def jsonObj    = "{" ~> repsep(objEntry, ",") <~ "}" ^^ { case vals : List[_] => JSONObject(ListMap(vals : _*)) }
